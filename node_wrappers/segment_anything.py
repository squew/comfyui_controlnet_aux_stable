...
class SAM_Preprocessor:
    ...
    def execute(self, image, resolution=512, **kwargs):
        ...
        mobile_sam = SamDetector.from_pretrained(f"{annotator_ckpts_path}/dhkim2810/MobileSAM", model_type="vit_t", filename="mobile_sam.pt", cache_dir=annotator_ckpts_path).to(model_management.get_torch_device())
